...
if __name__ == '__main__':
    ...
    aim_dir1 = 'VOCdevkit/train/images/'
    # source_path1 = os.path.join(wd, "trainsplit\\images\\")
    source_path1 = os.path.join(wd, "VOCdevkit/images/train/")
    ...
    aim_dir2 = 'VOCdevkit/train/labelTxt/'
    # source_path2 = os.path.join(wd, "trainsplit\\labelTxt\\")
    source_path2 = os.path.join(wd, "VOCdevkit/labels/train/")
    ...
    aim_dir3 = 'VOCdevkit/val/images/'
    source_path3 = os.path.join(wd, "VOCdevkit/images/val/")
    ...
    aim_dir4 = 'VOCdevkit/val/labelTxt/'
    source_path4 = os.path.join(wd, "VOCdevkit/labels/val")
